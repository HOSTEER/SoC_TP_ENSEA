...
#define SHIFTING_COUNT 508 //Plus il est bas, plus le message défilera vite
...
void Animer_message(uint8_t sens){//sens de défilement, à gauche 0, à droite 1
	static uint16_t countBeforeShifting=0;
	static uint8_t decalage=0;
	if(countBeforeShifting>SHIFTING_COUNT){
